...
const weeks = [
  ...
  },
  {
    ...
    description: "Phase 2 production week. Problem framing is locked from Phase 1. Designer builds 4 deliverables each showing a different surface or expression of the feature — progress bar, category breakdown, setup screen, mobile widget. The question now: which visual expression best communicates the solved problem?",
