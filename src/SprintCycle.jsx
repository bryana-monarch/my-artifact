...
const weeks = [
  {
    ...
    accentColor: "#7C3AED",
    days: [
      { day: "MON", content: "Designer begins product audit and follows up with product team or PMM to gut-check understanding and fill gaps", highlight: true },
      { day: "TUE", content: "Designer documents product nuance in approved one-sheeter.", highlight: false },
  ...
  },
  {
    ...
    days: [
      ...
      { day: "FRI", content: "Final files handed off by 4pm PST and launched same day.", highlight: true },
    ],
    description: "Designer builds 4 deliverables testing 4 different JTBD / problem framings against a locked surface and locked visual system. The only variable is the problem framing — which tension does this feature solve? Files handed off and launched Friday by 4pm PST, results by Wednesday.",
  ...
  },
  {
    ...
    accentColor: "#1D4ED8",
    days: [
      { day: "MON", content: "Batch A live — Designer has capacity for overflow work", highlight: true },
      { day: "TUE", content: "Designer has capacity for overflow work", highlight: false },
      { day: "WED", content: "Designer reviews results / creates slide in weekly deck", highlight: false },
      { day: "THU", content: "Results review with strategist. Winning problem framing identified.", highlight: true },
      { day: "FRI", content: "Phase 2 brief finalized and handed to production by 4pm EST.", highlight: true },
    ],
  ...
  },
  {
    ...
    description: "Phase 2 production week. Problem framing is locked from Phase 1. Designer builds 4 deliverables each showing a different surface or expression of the feature (i.e — progress bar, category breakdown, setup screen, mobile widget, etc.) The question now: which visual expression best communicates the solved problem? Files handed off and launched Friday by 4pm PST, results by Wednesday.",
  ...
  },
  {
    ...
    accentColor: "#1D4ED8",
    days: [
      { day: "MON", content: "Batch B live — Designer has capacity for overflow work", highlight: true },
      { day: "TUE", content: "Designer has capacity for overflow work", highlight: false },
      { day: "WED", content: "Designer reviews results / creates slide in weekly deck", highlight: false },
      { day: "THU", content: "Results review with strategist. Winning surface identified.", highlight: true },
      { day: "FRI", content: "Phase 3 brief finalized and handed to production by 4pm EST.", highlight: true },
    ],
  ...
  },
  {
    number: 6,
    type: "live-retro",
    label: "Live + Retro + Next Cycle Kickoff",
    sublabel: "BATCH C",
    color: "#059669",
    accentColor: "#059669",
    days: [
      { day: "MON", content: "Batch C live — Designer audits next feature in product, exploring all functional use cases in a demo environment and documenting findings in a one-sheeter. Follows up with product team or PMM to gut-check understanding and fill gaps.", highlight: true },
      { day: "TUE", content: "Designer begins visual system direction prep for next feature.", highlight: false },
      { day: "WED", content: "Designer reviews results / creates slide in weekly deck", highlight: false },
      { day: "THU", content: "Strategist Full Retro: synthesize all 3 phases into complete positioning verdict. Package notes for PM. Next feature confirmed.", highlight: true },
      { day: "FRI", content: "Next cycle fully briefed and handed off to creative ops by 4pm EST.", highlight: true },
    ],
...
const typeConfig = {
  ...
  "live-retro": { label: "Live + Retro + Kickoff",  symbol: "✓" },
};
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          {[
            ...
            { color: "#059669", label: "Live + Retro + Kickoff", desc: "Final window, synthesis + next brief" },
